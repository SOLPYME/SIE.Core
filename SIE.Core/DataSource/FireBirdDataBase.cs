...
{
    public class FireBirdDataBase : IDataSource
    {
        ...
        public SqlMapper.GridReader ExecuteDapperMultipleQuery(string query, object? parameters = null, int? timeOut = null)
        {
            throw new NotImplementedException();
        }

        public Task<SqlMapper.GridReader> ExecuteDapperMultipleQueryAsync(string query, object? parameters = null, int? timeOut = null)
        {
            throw new NotImplementedException();
        }
        ...
        public SqlMapper.GridReader SelectMultipleQuery(string query, object? parameters = null, int? timeOut = null)
        {
            throw new NotImplementedException();
        }

        public Task<SqlMapper.GridReader> SelectMultipleQueryAsync(string query, object? parameters = null, int? timeOut = null)
        {
            throw new NotImplementedException();
        }
        ...
        public SqlMapper.GridReader TransactionalMultipleQuery(string query, object? parameters = null, int? timeOut = null)
        {
            throw new NotImplementedException();
        }

        public Task<SqlMapper.GridReader> TransactionalMultipleQueryAsync(string query, object? parameters = null, int? timeOut = null)
        {
            throw new NotImplementedException();
        }
